...
const SpecialityMenu = () => {
    return (
        <div id='speciality' className='flex flex-col items-center gap-4 py-16 text-[#262626]'>
            <h1 className='text-3xl font-medium'>Mamandygy boıynsha tabyńyz</h1>
            <p className='sm:w-1/3 text-center text-sm'>Bizdiń senimdi dárigerlerdiń keń tizimin qarap shyǵyńyz, kezdesýdi esh qıyndyqsyz josparlańyz.</p>
